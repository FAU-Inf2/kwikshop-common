...
@NamedQueries({
        @NamedQuery(
                ...
                query = "SELECT s FROM ShoppingList s WHERE s.userId = :" + NamedQueryConstants.USER_ID
        ),
        @NamedQuery(
                name = NamedQueryConstants.SHOPPINGLIST_GET_BY_LISTID,
                query = "SELECT s FROM ShoppingList s WHERE s.userId = :" + NamedQueryConstants.USER_ID  + " and s.listId = :" + NamedQueryConstants.LIST_ID
        )
})
